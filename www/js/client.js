...
const welcomeImg = "../images/background.png";
const shareUrlImg = "../images/background.png";
const leaveRoomImg = "../images/background.png";
const aboutImg = "../images/preview.png";
const myChatAvatar = "../images/doge_senderpic.png";
const friendChatAvatar = "../images/messagerpic.png";
...
var recStartTime;
var recElapsedTime;
var swalBackground = "#1e2228"; // black - #16171b ...
...
function getHtmlElementsById() {
  countTime = getId("counttimebuttonatpalette");
  myVideo = getId("myVideo");
  // left buttons
  leftButtons = getId("leftButtons");
  shareRoomBtn = getId("shareRoomBtn");
  audioBtn = getId("audioBtn");
 counttimebuttonatpalette = getId("counttimebuttonatpalette");
...
function setButtonsTitle() {
  ...
  tippy(counttimebuttonatpalette, {
...
function initPeer() {
  ...
  function welcomeUser() {
    ...
    Swal.fire({
      ...
      imageAlt: "dogemeet-welcome",
      imageUrl: welcomeImg,
      html:
        `
      <br/> 
      Share this URL to invite your epic friends.
...
function getAbout() {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    title: "<strong>Doge Meet</strong>",
    imageAlt: "mirotalk-about",
    imageUrl: aboutImg,
    html: `
    <br/>
    <div id="about"><b>Doge media</b> <p> A video calling site managed and developed by Developers at doge media</div>
    <div id="author"><a href="https://www.linkedin.com/in/miroslav-pejic-976a07101/" target="_blank">Special Thanks to MiroSlav Pejic</a></div><br>
    `,
    showClass: {
      popup: "animate__animated animate__fadeInDown",
    },
